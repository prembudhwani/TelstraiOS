...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.databaseObject = [[CoreDataWrapper alloc]init];
    self.databaseObject.objectModelName = @"TelstraiOS";
    self.databaseObject.fileName = @"TelstraiOS.sqlite";
    [self.databaseObject initCoreData];
